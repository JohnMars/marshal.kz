...
Как же стать таким молодым специалистом, который будет востребованным специалистом на рынке.
...
Но без фундаментальных знании вы со временем уткнетесь к тому,
...
## Принципы OOP
Принцип OOP включает в себя: Encapsulation, Abstraction, Inheritance и Polymorphism.
...
давая при этом публичные либо частично скрытый доступ к нему.
...
Различные объекты часто общаются друг с другом. Поэтому поддерживать такие проекты с
...
Данный модель должен предоставить другим объектам **только** механизм взаимодействия связанное с данной моделью.
...
Пользователь не должен знать как будет изготавливаться кофе, он только взаимодействует с публичными методами кофемашины. Желательно чтобы этот абстрактный объект был
