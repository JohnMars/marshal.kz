...
Представьте себе что вам нужно создать объект кофе кофемашина. Пользователь должен
предоставить чашку и нажать на кнопку чтобы кофемашина начала наполнять чашку кофе.
Пользователь не должен знать как будет готовиться кофе, он только взаимодействует с
публичными методами кофемашины. Желательно чтобы этот абстрактный объект (Кофе машина) был
